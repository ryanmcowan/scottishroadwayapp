...
public class IncidentFragmentModel extends AsyncTask<String, Void, List<DataModel>> {
    ...
    public ResponseIncidentModel responceincident = null;
    ...
    protected void onPostExecute(List<DataModel> dataModelsItems) {
        ...
        responceincident.onCompleteProcessIncident(dataModelsItems);
    }
}
