...
public class RoadWorkFragmentModel extends AsyncTask<String, Void, List<DataModel>> {
    ...
    public ResponseRoadWorksModel responseRoadWork= null;
    ...
    protected void onPostExecute(List<DataModel> dataModelsItems) {
        ...
        responseRoadWork.onCompleteProcessRoadWork(dataModelsItems);
    }
}
